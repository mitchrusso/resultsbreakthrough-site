...
const articlePlan = [
  ...
  ["Mitch Russo Books Reading Order: Which One Fits Your Business Stage?", "mitch-russo-books-reading-order", "2026-07-20", "Business Books", images.books, ["Mitch Russo books", "The Invisible Organization", "Power Tribes", "Licensing for Leverage", "Coach Elevation", "Sacred Profits"]],
  ["Atomic Habits for Entrepreneurs: The Products That Help You Apply It", "atomic-habits-for-entrepreneurs", "2026-07-21", "Business Books", images.books, ["Atomic Habits for entrepreneurs", "habit tracker", "productivity tools"]],
  ["Deep Work for Entrepreneurs: How to Build a Focus Stack", "deep-work-for-entrepreneurs", "2026-07-22", "Business Books", images.books, ["Deep Work for entrepreneurs", "focus stack", "deep work tools"]],
  ["The 12 Week Year Planning Tools: What to Buy and What to Skip", "12-week-year-planning-tools", "2026-07-23", "Accountability Systems", images.habits, ["12 Week Year planner", "weekly scorecard", "execution planning"]],
  ["Habit Trackers for Entrepreneurs: Simple Scorecards That Actually Get Used", "habit-trackers-for-entrepreneurs", "2026-07-24", "Accountability Systems", images.habits, ["habit tracker for entrepreneurs", "weekly scorecard", "accountability tools"]],
  ["Remote Work Gear Checklist for a Cleaner Daily Workflow", "remote-work-gear-checklist", "2026-07-27", "Remote Work Gear", images.remote, ["remote work gear checklist", "home office gear", "productivity setup"]],
  ["Accountability Tools for Founders Who Do Not Need Another App Graveyard", "accountability-tools-for-founders", "2026-07-28", "Accountability Systems", images.habits, ["accountability tools for founders", "goal tracking", "weekly review"]],
  ["Weekly Scorecard Tools: How to Track Lead Measures Without Overbuilding", "weekly-scorecard-template-tools", "2026-07-29", "Accountability Systems", images.habits, ["weekly scorecard tools", "lead measures", "business accountability"]],
  ["Personal Kanban for Entrepreneurs: How to See Work Before It Stalls", "personal-kanban-for-entrepreneurs", "2026-07-30", "Goal Planners", images.planner, ["personal Kanban for entrepreneurs", "Kanban whiteboard", "visual project management"]],
  ["Best Portable Monitor Setup for Founders Who Travel", "best-portable-monitor-setup-for-founders", "2026-07-31", "Remote Work Gear", images.remote, ["portable monitor for laptop", "travel work setup", "remote founder gear"]],
  ["How to Choose a USB Microphone for Sales Calls and Webinars", "usb-microphone-for-sales-calls", "2026-08-03", "Remote Work Gear", images.remote, ["USB microphone for sales calls", "webinar microphone", "remote work audio"]],
  ["Blue-Light Glasses, Breaks, and Better Shutdown Routines", "blue-light-glasses-shutdown-routine", "2026-08-04", "Focus Timers", images.focus, ["blue light glasses for computer work", "shutdown routine", "screen fatigue tools"]],
  ["OKR Workbook vs 90-Day Planner: Which One Fits Your Business?", "okr-workbook-vs-90-day-planner", "2026-08-05", "Accountability Systems", images.habits, ["OKR workbook", "90 day planner", "goal achievement system"]],
  ["Sleep Trackers for Entrepreneurs: What to Measure and What to Ignore", "sleep-trackers-for-entrepreneurs", "2026-08-06", "Accountability Systems", images.habits, ["sleep tracker for entrepreneurs", "recovery tools", "personal performance"]],
  ["The Founder Desk Setup Checklist for Video, Writing, and Deep Work", "founder-desk-setup-checklist", "2026-08-07", "Desk Setup", images.desk, ["founder desk setup", "entrepreneur workspace checklist", "desk gear for deep work"]],
  ["Business Books Are Not Enough: How to Turn Reading Into an Operating System", "turn-business-books-into-operating-system", "2026-08-10", "Business Books", images.books, ["business books implementation", "productivity books for entrepreneurs", "operating system for founders"]],
] as const;
