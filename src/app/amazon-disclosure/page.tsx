...
export const metadata: Metadata = { title: "Amazon Affiliate Disclosure", description: "Amazon affiliate disclosure for ResultsBreakthrough.", alternates: { canonical: "/amazon-disclosure" } };
